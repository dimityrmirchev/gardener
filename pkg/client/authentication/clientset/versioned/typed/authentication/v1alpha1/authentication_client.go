...
func (c *AuthenticationV1alpha1Client) AdminKubeconfigRequests(namespace string) AdminKubeconfigRequestInterface {
	return newAdminKubeconfigRequests(c, namespace)
}

func (c *AuthenticationV1alpha1Client) WorkloadIdentities(namespace string) WorkloadIdentityInterface {
