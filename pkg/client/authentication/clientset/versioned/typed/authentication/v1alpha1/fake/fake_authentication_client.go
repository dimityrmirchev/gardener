...
func (c *FakeAuthenticationV1alpha1) AdminKubeconfigRequests(namespace string) v1alpha1.AdminKubeconfigRequestInterface {
	return &FakeAdminKubeconfigRequests{c, namespace}
}
