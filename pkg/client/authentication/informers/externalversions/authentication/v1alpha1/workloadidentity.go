	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AuthenticationV1alpha1().WorkloadIdentities(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AuthenticationV1alpha1().WorkloadIdentities(namespace).Watch(context.TODO(), options)
			},
		},
		&authenticationv1alpha1.WorkloadIdentity{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workloadIdentityInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authenticationv1alpha1.WorkloadIdentity{}, f.defaultInformer)
}
