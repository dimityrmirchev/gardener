...
func newTableConvertor() rest.TableConvertor {
	return &convertor{
		headers: []metav1beta1.TableColumnDefinition{
			...
			{Name: "Audiences", Type: "string", Format: "name", Description: swaggerMetadataDescriptions["audiences"]},
...
func (c *convertor) ConvertToTable(_ context.Context, obj runtime.Object, _ runtime.Object) (*metav1beta1.Table, error) {
	...
	table.Rows, err = metatable.MetaToTableRow(obj, func(obj runtime.Object, m metav1.Object, name, age string) ([]interface{}, error) {
		...
		cells = append(cells, workloadIdentity.Name)
		cells = append(cells, strings.Join(workloadIdentity.Spec.Audiences, ","))
		cells = append(cells, metatable.ConvertToHumanReadableDateType(workloadIdentity.CreationTimestamp))
